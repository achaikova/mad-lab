...
from mad.model.layers.titans.associative_scan import AssocScan
        ...
        for (param_name, surprise), (_, last_update) in zip(surprises.items(), past_last_update.items()):
            ...
            if has_momentum:
                ...
                for one_adaptive_momentum, one_last_momentum in zip_longest(adaptive_momentum, last_momentum):
                    # print("one_adaptive_momentum.dtype", one_adaptive_momentum.dtype, "one_last_momentum.dtype", one_last_momentum.dtype)
